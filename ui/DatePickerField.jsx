...
const DatePickerField = ({ label, date, setDate }) => {
  return (
    <div className="flex flex-col justify-center items-center">
      ...
      <DatePicker
        containerClassName="w-full group bg-pink-200 hover:bg-pink-300 border border-purple-400 ring-2 ring-purple-500 ring-offset-2 rounded-md shadow-xl py-1 cursor-pointer pr-24"
